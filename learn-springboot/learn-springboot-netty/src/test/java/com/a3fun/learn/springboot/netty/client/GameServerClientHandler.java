 ...
 */
@Component
public class GameServerClientHandler extends SimpleChannelInboundHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(GameServerClientHandler.class);
